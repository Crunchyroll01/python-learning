...
Name: _______Cody Fancil__________
...
"""
    ...
    for entry in log_entries:
        ...
        timestamp_end = None
        level_start = None  # find start of INFO|ERROR|WARNING Skip "] "
        level_end = None # find start of INFO|ERROR|WARNING before ":"
        
        # TODO 1: Extract timestamp (between [ and ])
        timestamp = None  # Replace None
        
        # TODO 2: Extract log level (INFO, ERROR, WARNING)
        level = None  # Replace None
        
        # TODO 3: Extract message (everything after level:)
        message = None  # Replace None
